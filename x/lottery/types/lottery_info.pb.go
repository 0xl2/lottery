...
type LotteryInfo struct {
	...
	NextOrder uint64 `protobuf:"varint,2,opt,name=nextOrder,proto3" json:"nextOrder,omitempty"`
}
...
func (m *LotteryInfo) GetNextOrder() uint64 {
	if m != nil {
		return m.NextOrder
	}
	return 0
...
var fileDescriptor_a8cadedeb4e07f20 = []byte{
	...
	0x30, 0x5a, 0xc9, 0x99, 0x8b, 0xdb, 0x07, 0xc2, 0xf4, 0xcc, 0x4b, 0xcb, 0x17, 0x12, 0xe3, 0x62,
	0xcb, 0x4b, 0xad, 0x28, 0xf1, 0x4c, 0x91, 0x60, 0x54, 0x60, 0xd4, 0x60, 0x09, 0x82, 0xf2, 0x84,
	0x64, 0xb8, 0x38, 0x41, 0x2c, 0xff, 0xa2, 0x94, 0xd4, 0x22, 0x09, 0x26, 0xb0, 0x14, 0x42, 0xc0,
	...
	0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x11, 0xae, 0x80, 0x3b, 0xb6, 0x02, 0xce, 0x2a,
	0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x3b, 0xd8, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x22,
	0x8d, 0x55, 0x0c, 0xd6, 0x00, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NextOrder |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
