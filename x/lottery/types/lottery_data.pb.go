...
type LotteryData struct {
	MinBet int64 `protobuf:"varint,1,opt,name=minBet,proto3" json:"minBet,omitempty"`
	MaxBet int64 `protobuf:"varint,2,opt,name=maxBet,proto3" json:"maxBet,omitempty"`
...
func (m *LotteryData) GetMinBet() int64 {
	if m != nil {
		return m.MinBet
	}
	return 0
...
func (m *LotteryData) GetMaxBet() int64 {
	if m != nil {
		return m.MaxBet
	}
	return 0
...
func (m *LotteryData) GetFee() int64 {
	if m != nil {
		return m.Fee
	}
	return 0
...
var fileDescriptor_10da7f793706a590 = []byte{
	...
	0xcb, 0xcd, 0xcc, 0x73, 0x4a, 0x2d, 0x91, 0x60, 0x54, 0x60, 0xd4, 0x60, 0x0e, 0x82, 0xf2, 0xc0,
	...
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xef, 0xe6, 0xab, 0x0b, 0xe2, 0x00, 0x00, 0x00,
}
