...
export const LotteryInfo = {
  encode(message: LotteryInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nextId !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LotteryInfo {
  ...
  toJSON(message: LotteryInfo): unknown {
    const obj: any = {};
