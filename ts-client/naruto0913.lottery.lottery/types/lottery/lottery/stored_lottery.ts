...
function createBaseStoredLottery(): StoredLottery {
  return { index: "", winner: "", winIndex: 0, fee: 0, minBet: 0 };
}
...
export const StoredLottery = {
  encode(message: StoredLottery, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.winIndex !== 0) {
      writer.uint32(24).uint64(message.winIndex);
    }
    if (message.fee !== 0) {
      writer.uint32(32).uint64(message.fee);
    }
    if (message.minBet !== 0) {
      writer.uint32(40).uint64(message.minBet);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.winIndex = longToNumber(reader.uint64() as Long);
          break;
        case 4:
  ...
  fromJSON(object: any): StoredLottery {
    return {
      ...
      winIndex: isSet(object.winIndex) ? Number(object.winIndex) : 0,
  ...
  toJSON(message: StoredLottery): unknown {
    ...
    message.winIndex !== undefined && (obj.winIndex = Math.round(message.winIndex));
  ...
  fromPartial<I extends Exact<DeepPartial<StoredLottery>, I>>(object: I): StoredLottery {
    ...
    message.winIndex = object.winIndex ?? 0;
