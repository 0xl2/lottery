...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/naruto0913/lottery/lottery/params
   */
   ...
   * @request GET:/naruto0913/lottery/lottery/stored_lottery
   */
  queryStoredLotteryAll = (
    ...
    this.request<LotteryQueryAllStoredLotteryResponse, RpcStatus>({
      path: `/naruto0913/lottery/lottery/stored_lottery`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/naruto0913/lottery/lottery/stored_lottery/{index}
   */
  queryStoredLottery = (index: string, params: RequestParams = {}) =>
    this.request<LotteryQueryGetStoredLotteryResponse, RpcStatus>({
      path: `/naruto0913/lottery/lottery/stored_lottery/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
